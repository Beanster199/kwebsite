...
app.get('/support', async (req,res) =>{
    ...
    const _tickets = await connection.query('SELECT * FROM kwebsite_tickets ktw LEFT JOIN kwebsite_tickets_categories ktc on ktc.id = ktw.category_id ORDER BY ktw.date desc');
